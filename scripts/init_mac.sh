#!/usr/bin/env bash
LIB_URL="https://github.com/funatsufumiya/TrussC-nim/releases/download/v0.0/osx_libs.zip"
DYLIB_URL="https://github.com/funatsufumiya/TrussC-nim/releases/download/v0.0/osx_dylibs.zip"
LIB_DEST=lib/osx
DYLIB_DEST=.
